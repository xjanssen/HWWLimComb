...
combinations = { 
  ...
  'hww2l2v_Paper'        : { 'energies' : [ '7TeV' , '8TeV' ] , 'channels' : [ 'hww2l2v_0jsf_cut_Paper'   , 'hww2l2v_1jsf_cut_Paper' , 
                          ...
                          'purposes' : [ 'himass' ] , 'legend' : 'HWW 0/1/2j SF+DF '   } ,
