...
for iPlot in options.plots:
   ...
   #
     ...
     for iModel in PhysModelList:
       print '---------------------------> Model = '+iModel 
       plot=combPlots.combPlot(options.Version,options.unblind,postFix,options.logx,False,iTitle,iLumi)
     ...
     for iModel in PhysModelList:
       ...
       for iComb in combList:
         ...
         for iMass in massList:
           plot=combPlots.combPlot(options.Version,options.unblind,postFix,False,False,iTitle,iLumi)
